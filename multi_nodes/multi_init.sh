...
TEST_ACCOUNTS=(
	"dydx199tqg4wdlnu4qjlxchpd7seg454937hjrknju4" # surf1
	"dydx10fx7sy6ywd5senxae9dwytf8jxek3t2gcen2vs" # surf2
	"dydx1fjg6zp6vv8t9wvy4lps03r5l4g7tkjw9wvmh70" # surf3
	"dydx1wau5mja7j7zdavtfq9lu7ejef05hm6ffenlcsn" # surf4
)
...
create_validators() {
	...
	FIRST_VAL_HOME_DIR="./chain/.${MONIKERS[0]}"
